                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold text-dark"><?php echo htmlspecialchars($c['first_name'] . ' ' . $c['last_name']); ?></div>
                                </td>
                                <td>
                                    <div class="text-primary small"><i class="bi bi-envelope me-1"></i><?php echo htmlspecialchars($c['email']); ?></div>
                                </td>
                                <td>
                                    <span class="badge bg-secondary-subtle text-secondary border rounded-pill px-3">
                                        <i class="bi bi-people me-1"></i><?php echo htmlspecialchars($c['group_name'] ?? 'General'); ?>
                                    </span>
                                </td>
