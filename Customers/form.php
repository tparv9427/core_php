    ...
    <div class="row justify-content-center mx-3 mt-4">
        ...
        <form method="POST" action="<?php echo $isEdit ? 'edit.php' : 'add.php'; ?>" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="first_name" name="customer[first_name]" value="<?php echo htmlspecialchars($customerModel->value('first_name') ?? ''); ?>" placeholder="John" required>
            </div>

            <div class="col-md-6">
                <label for="last_name" class="form-label fw-semibold text-secondary small text-uppercase">Last Name</label>
                <input type="text" class="form-control" id="last_name" name="customer[last_name]" value="<?php echo htmlspecialchars($customerModel->value('last_name') ?? ''); ?>" placeholder="Doe" required>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="email" class="form-control" id="email" name="customer[email]" value="<?php echo htmlspecialchars($customerModel->value('email') ?? ''); ?>" placeholder="john.doe@example.com" required>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="customer[phone]" value="<?php echo htmlspecialchars($customerModel->value('phone') ?? ''); ?>" placeholder="+1 (555) 000-0000">
                </div>
            </div>
