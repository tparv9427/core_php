...
<body class="bg-light pb-5">
    ...
    <div class="container bg-white p-5 rounded-4 shadow-sm border">
        <div class="row align-items-center mb-4">
            <div class="col-md-6">
                <h1 class="h3 fw-bold text-dark m-0">Categories</h1>
                <p class="text-muted small">Organize your products into logical collections.</p>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                <td><input type="checkbox" name="selected_ids[]" value="<?php echo $c['category_id']; ?>" class="form-check-input rowCheckbox"></td>
                                <td class="fw-bold text-secondary">#<?php echo $c['category_id']; ?></td>
                                <td>
                                    <div class="fw-bold text-dark"><?php echo htmlspecialchars($c['name']); ?></div>
                                    <div class="small text-muted text-truncate" style="max-width: 300px;"><?php echo htmlspecialchars($c['description']); ?></div>
                                </td>
                                ...
                                <td class="small text-muted text-center" style="font-size: 0.75rem;">
                                    <div><i class="bi bi-calendar-event me-1"></i><?php echo $c['created_date']; ?></div>
                                    <?php if ($c['updated_date']): ?>
                                        <div class="mt-1"><i class="bi bi-pencil-square me-1"></i><?php echo $c['updated_date']; ?></div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                        <a href="form.php?id=<?php echo $c['category_id']; ?>" class="btn btn-sm btn-outline-primary shadow-sm" title="Edit">
