        ...
        <form method="POST" action="<?php echo $isEdit ? 'edit.php' : 'add.php'; ?>" class="row g-3">
            ...
            <div class="col-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="file_path" name="product_media[file_path]" value="<?php echo htmlspecialchars($productMediaModel->value('file_path') ?? ''); ?>" placeholder="/assets/images/product-1.jpg" required>
                </div>
            </div>

            <div class="col-md-8">
                <label for="alt_text" class="form-label fw-semibold text-secondary small text-uppercase">Alternative Text</label>
                <input type="text" class="form-control" id="alt_text" name="product_media[alt_text]" value="<?php echo htmlspecialchars($productMediaModel->value('alt_text') ?? ''); ?>" placeholder="Describe the image for SEO">
            </div>
