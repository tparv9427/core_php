                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="fw-bold text-dark"><?php echo htmlspecialchars($pm['product_name'] ?? 'Unassigned'); ?></div>
                                    <div class="small text-muted"><i class="bi bi-link-45deg me-1"></i><?php echo htmlspecialchars($pm['file_path']); ?></div>
                                    <div class="small text-muted fst-italic">Alt: <?php echo htmlspecialchars($pm['alt_text'] ?? '-'); ?></div>
                                </td>
                                <td>
