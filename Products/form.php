    ...
    <div class="row justify-content-center mx-3 mt-4">
        ...
        <form method="POST" action="<?php echo $isEdit ? 'edit.php' : 'add.php'; ?>" class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="name" name="product[name]" value="<?php echo htmlspecialchars($productModel->value('name') ?? ''); ?>" placeholder="e.g. Wireless Mouse" required>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" id="description" name="product[description]" rows="4" placeholder="Brief details about your product..."><?php echo htmlspecialchars($productModel->value('description') ?? ''); ?></textarea>
            </div>
